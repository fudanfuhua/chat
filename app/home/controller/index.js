...
var numUsers = 0;var _default = (function (_Base) {_inherits(_default, _Base);function _default() {_classCallCheck(this, _default);_Base.apply(this, arguments);}
  ...
  imgAction = function imgAction(self) {
    var socket = self.http.socket;
    console.log(11111);
    this.broadcast('img', { 
      username: socket.username, 
      img: self.http.data });};return _default;})(_baseJs2['default']);exports['default'] = _default;module.exports = exports['default'];